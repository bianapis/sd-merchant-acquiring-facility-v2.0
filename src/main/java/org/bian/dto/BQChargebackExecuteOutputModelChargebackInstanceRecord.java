...
/**
 * BQChargebackExecuteOutputModelChargebackInstanceRecord
 */
public class BQChargebackExecuteOutputModelChargebackInstanceRecord   {
  private String cardTransactionRecordReference = null;


  /**
   * `status: Not Mapped`  core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::ISO20022andUNCEFACT::Identifier  general-info: Reference to the card transaction for the chargeback  cardTransactionDateTime:  type: string  example: \"09-22-2018\"  description: |   `status: Not Mapped`    core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::UNCEFACT::DateTime    general-info: Significant dates and times associated with the transaction 
